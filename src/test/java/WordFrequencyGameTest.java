...
public class WordFrequencyGameTest {
    ...
    private void validate_Input_words_process_to_expected_word(String inputSentence, String expectResult) throws CalculationErrorException {
        WordFrequencyGame game = new WordFrequencyGame();
        //When
        String gameResult = game.getResult(inputSentence);
        //Then
        assertEquals(gameResult, expectResult);
    }
}
